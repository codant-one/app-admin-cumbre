...
(function ($) {
    ...
    var appcumbre = {
        ...
        sliderActivation: {
            ...
            /* Slider Initializer */
            init: function () {
                appcumbre.sliderActivation.screenshotSlider();
                appcumbre.sliderActivation.teamMemberSlider();
                appcumbre.sliderActivation.blogSlider();
                appcumbre.sliderActivation.testimonialSlider();
            }
        },
        ...
        /* Initializer */
        init: function () {
            appcumbre.preloaderCancellation();
            appcumbre.dataBgImage();
            appcumbre.sliderActivation.init();
            appcumbre.counterupActivation();
            appcumbre.funfactMasonryActive();
            appcumbre.dynamicPricebox();
            appcumbre.contactFormEffect();
            appcumbre.scrollToSection();
            appcumbre.stickyHeaderActive();
            appcumbre.meanmenuActive();
            appcumbre.breadcrumbPadding();
            appcumbre.scrollSpyActive();
            appcumbre.fancyboxInit();
            appcumbre.ajaxMailchimp();
            appcumbre.scrollUpActive();
            appcumbre.easeScrollActive();
            appcumbre.herosliderScrollMagic();
            appcumbre.blogMasonryActive();
            appcumbre.ajaxMailer();
            appcumbre.serviceImageAnim();
        }
    };
