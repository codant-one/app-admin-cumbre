...
<table cellpadding="0" cellspacing="0" width="100%" bgcolor="#FFFFFF" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;border-width:10px;border-style:solid;border-color:transparent;background-color:#ffffff;border-radius:32px">
    <tr>
        <td colspan="2" align="center" style="padding:0;margin:0;padding-top:30px">
    ...
    <tr>
        <td colspan="2" align="center" style="padding:0;margin:0;padding-top:15px;padding-bottom:20px;border-bottom: 1px solid #D9EEF2;">
    ...
    <tr>
        <td colspan="2" align="center" style="padding:0;margin:0;padding-top:10px;padding-bottom:15px">
            <p style="margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:36px;color:#0a1b33;font-size:24px">
    ...
    <tr>
        <td colspan="2" align="center" style="padding:0;margin:0;padding-bottom:15px;padding-left:15px;padding-right:15px">
    ...
    <tr>
        <td colspan="2" align="center" style="padding:0;margin:0;padding-top:15px;padding-bottom:15px;border-bottom: 1px solid #D9EEF2;">
            <p style="margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:36px;color:#0a1b33;font-size:24px">
                Usuario:&nbsp;<br>
    ...
    <tr>
        <td align="center" style="padding:0;margin:0;padding-bottom:40px;padding-left:10px;padding-right:10px">
