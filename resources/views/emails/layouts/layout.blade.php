...
<html xmlns="http://www.w3.org/1999/xhtml" lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>E-mails VII Cumbre del Petróleo, Gas y Energía</title>
    ...
    <body style="width:100%;font-family:Inter;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;margin:0">
                        ...
                        <table class="es-header" cellspacing="0" cellpadding="0" align="center" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;table-layout:fixed !important;width:100%;background-color:transparent;background-repeat:repeat;background-position:center top">
                            <tr>
                                <td align="center" style="padding:0;margin:0">
                                    <table class="es-header-body" cellspacing="0" cellpadding="0" align="center" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background:radial-gradient(#3F73D5, #003393, #001B4F);width:600px">
                                        <tr>
                                            <td align="left" style="padding:20px;margin:0;background-color:radial-gradient(center, #3F73D5, #003393, #001B4F);">
                                        ...
                                        <tr>
                                            <td align="left" style="margin:0;padding-top:25px;padding-bottom:0;padding-left:40px;padding-right:40px;">
                                                @include("emails.layouts.footer")
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left" style="margin:0;padding-top:0;padding-bottom:0;padding-left:40px;padding-right:40px;">
