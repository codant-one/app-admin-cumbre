...
@section('content')
    ...
    @include('admin.cruds.schedules.partials.table-list')
...
@php
    $edit_route = route("schedules.edit", ["schedule" => 'id-here']);
    $delete_route = route("schedules.destroy", ["schedule" => 'id-here']);
@endphp
		                ...
		                render: function (data) {
		                    return `
		                        <div class="form-check form-check-sm form-check-custom form-check-solid justify-content-center">
		                            <input class="form-check-input" type="checkbox" name="schedules[]" value="${data}" />
		                        </div>
                               `;
		                }
		            },
