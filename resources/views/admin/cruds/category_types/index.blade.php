...
@section('content')
    ...
    @include('admin.cruds.category_types.partials.table-list')
...
@php
    $edit_route = route("category-types.edit", ["category_type" => 'id-here']);
    $delete_route = route("category-types.destroy", ["category_type" => 'id-here']);
@endphp
...
<script>
    $(document).ready(function () {
		...
		const table = $('.table').DataTable({
            ...
            orderCellsTop: true,
            ajax: {
                url: "{{ route('category-types.index') }}",
		                ...
		                render: function (data) {
		                    return `
		                        <div class="form-check form-check-sm form-check-custom form-check-solid justify-content-center">
		                            <input class="form-check-input" type="checkbox" name="category-types[]" value="${data}" />
		                        </div>
                               `;
		                }
		            },
