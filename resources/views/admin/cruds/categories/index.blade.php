...
@section('content')
    ...
    @include('admin.cruds.categories.partials.table-list')
...
@php
    $edit_route = route("categories.edit", ["category" => 'id-here']);
    $delete_route = route("categories.destroy", ["category" => 'id-here']);
@endphp
		                ...
		                render: function (data) {
		                    return `
		                        <div class="form-check form-check-sm form-check-custom form-check-solid justify-content-center">
		                            <input class="form-check-input" type="checkbox" name="categories[]" value="${data}" />
		                        </div>
                               `;
		                }
		            },
