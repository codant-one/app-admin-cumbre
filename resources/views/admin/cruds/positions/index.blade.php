...
@section('content')
    ...
    @include('admin.cruds.positions.partials.table-list')
...
@php
    $edit_route = route("positions.edit", ["position" => 'id-here']);
    $delete_route = route("positions.destroy", ["position" => 'id-here']);
@endphp
		                ...
		                render: function (data) {
		                    return `
		                        <div class="form-check form-check-sm form-check-custom form-check-solid justify-content-center">
		                            <input class="form-check-input" type="checkbox" name="positions[]" value="${data}" />
		                        </div>
                               `;
		                }
		            },
