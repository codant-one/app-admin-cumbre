...
<div class="container-fluid">
    <div class="mx-5 mx-xl-15 my-7">
        <div class="card">
            ...
            {!!  Form::open(['route' => ['positions.update', ['position' => $position->id]], 'method' => 'PUT']) !!}
                @csrf

                <div class="row mb-6">
                    <label class="col-lg-4 col-form-label required fw-bold fs-6">Nombre en español</label>
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        {!! Form::text('name_es', old('name_es', $position->name_es),
                            ['required',
                            'id' => 'name_es',
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        {!! Form::text('name_en', old('name_en', $position->name_en),
                            ['required',
                            'id' => 'name_en',
                            'class' => 'form-control form-control-solid mb-3 mb-lg-0',
            ...
            <div class="card-footer d-flex justify-content-end py-6 px-9">
                <a href="{{ route('positions.index') }}" class="btn btn-light me-2">Regresar</a>
