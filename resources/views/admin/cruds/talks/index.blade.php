...
@section('content')
    ...
    @include('admin.cruds.talks.partials.table-list')
...
@php
    $edit_route = route("talks.edit", ["talk" => 'id-here']);
    $delete_route = route("talks.destroy", ["talk" => 'id-here']);
@endphp
		                ...
		                render: function (data) {
		                    return `
		                        <div class="form-check form-check-sm form-check-custom form-check-solid justify-content-center">
		                            <input class="form-check-input" type="checkbox" name="talks[]" value="${data}" />
		                        </div>
                               `;
		                }
		            },
