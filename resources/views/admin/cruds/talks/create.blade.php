@extends('admin.layouts.master', [
    ...
    'breadcrumbs' => [
        ...
        route('talks.create') => 'Agregar Nuevo'
    ]
])
...
<div class="container-fluid">
    <div class="mx-5 mx-xl-15 my-7">
        <div class="card">
            ...
            <div class="card-body">
            {!! Form::open(['route' => ['talks.store'], 'method' => 'POST', 'files' => true]) !!}
                @csrf
                <div class="row mb-7">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <label class="required fw-bold fs-6 mb-2">Agenda</label>
                ...
                <div class="row mb-7">
                    ...
                    <div class="col-md-3">
                        <div class="d-flex mt-8">
                            <div class="form-check form-switch form-check-custom form-check-solid align-items-start">
                                <label class="fw-bold fs-6 form-check-label mt-2 me-5 ms-0" for="shipping_submit">Hora</label>  
                                <div class="position-relative d-flex align-items-center">
                                    <div class="symbol symbol-20px me-4 position-absolute ms-4">
                                        <span class="symbol-label bg-secondary">
                                            <span class="svg-icon">
