    ...
    <div class="mx-5 mx-xl-15 my-7">
        <div class="card">
            ...
            <div class="card-body d-flex flex-center flex-column pt-12 p-9 px-0">
                {!! Form::open(['route' => ['roles.store'], 'method' => 'POST', 'style'=>'width:80%']) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        @foreach ($permissions as $permission)
                                            ...
                                            <div class="col-md-3 mb-2">
                                                <div class="form-group">
                                                    <label class="checkbox">
                                                    <input type="checkbox" class="checkbox-permission" id="permissions[]" name="permissions[]" value="{{ $permission->id }}">
            ...
            <div class="card-footer p-9 px-md-20">
                <div class="row text-center p-9 px-md-20">
                    <div class="col-12 col-md-6">
                        <a class="btn btn-light me-3 w-100 mt-2" href="{{ route('roles.index') }}">Regresar</a>
                    </div>
                    <div class="col-12 col-md-6">
