...
@section('content')
	...
	@include('admin.cruds.roles.partials.table-list')
...
@php
$edit_route = route("roles.edit", ["role" => 'id-here']);
$delete_route = route("roles.destroy", ["role" => 'id-here']);
@endphp
            ...
            columnDefs: [
                    {
		                ...
		                render: function (data) {
		                    return `@can('bank_delete')
		                        <div class="form-check form-check-sm form-check-custom form-check-solid justify-content-center">
		                            <input class="form-check-input" type="checkbox" name="roles[]" value="${data}" />
		                        </div>
                                @endcan`;
		                }
		            },
